/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d6429baa7d787f94011bc9caa4f8a29)
...
declare namespace Cloudflare {
	...
	interface Env {
		DATA_KV: KVNamespace;
		JWT_SECRET: string;
		VECTORIZE_EBKP: VectorizeIndex;
		VECTORIZE_NAME: VectorizeIndex;
		VECTORIZE_DESC: VectorizeIndex;
		AI: Ai;
	}
}
